...
[Unreleased]
Added
UX: connecting and disconnecting the wallet now show a success toast
("Wallet connected." / "Wallet disconnected."), matching every other
mutating action in the app. The toast is raised from ConnectButton's
click handlers rather than from WalletProvider, so a cross-tab
